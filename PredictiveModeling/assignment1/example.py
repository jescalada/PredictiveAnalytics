...
plt.bar([avgTargetLow, avgTargetMid, avgTargetHigh],
...
plt.xticks(ticks=[avgTargetLow, avgTargetMid, avgTargetHigh],
           labels=[avgTargetLow,avgTargetMid, avgTargetHigh], rotation=70)
