...
# Use forward feature selection to select the best features


X = df[['duration', 'pdays', 'previous', 'emp.var.rate', 'cons.price.idx',
        'euribor3m', 'nr.employed', 'contact_cellular', 'contact_telephone', 'month_mar', 'month_oct',
