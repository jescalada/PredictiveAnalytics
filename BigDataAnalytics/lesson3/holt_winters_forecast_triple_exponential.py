...
airline['HWES3_ADD'] = ExponentialSmoothing(airline['value'],
...
# seasonal data.
airline['HWES3_MUL'] = ExponentialSmoothing(airline['value'],
                 trend='mul',seasonal='mul',seasonal_periods=12).fit().fittedvalues

# Plot raw data as well as fitted values for both HWES3 models.
airline[['value','HWES3_ADD','HWES3_MUL']].plot(title='Holt Winters Triple Exponential Smoothing: Additive and Multiplicative Seasonality')
plt.show()
