...
FILE = "cleanedMovieReviews.tsv"
batch_1 = pd.read_csv(PATH + FILE, delimiter='\t')
batch_1 = batch_1[['Phrase', 'Sentiment']]
batch_1 = batch_1.rename(columns={'Phrase': 0, 'Sentiment': 1})
...
# The labels indicate which sentence is positive and negative
# now go into the labels variable
labels = batch_1[1]

# Split the data, train and predict.
