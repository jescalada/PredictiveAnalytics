...
def build_model(clip_size):
    ...
    # Compile the model.
    opt = SGD(lr=0.01, momentum=0.9, clipnorm=clip_size)
...
clip_sizes = [0.75, 0.8, 0.85, 0.9, 0.95, 1.0, 1.05, 1.1, 1.15, 1.2, 1.25]
for i in range(0, len(clip_sizes)):
    build_model(clip_sizes[i])
